...
UNIX manual pages (using the man command).

The C Programming Language (Second Edition) by Brian W. Kernighan and Dennis M. Ritchie.

### AI Usage

I create a gem in gemini that don't give direct answers to the learning flow of reasoning thinking don't be compromised.
